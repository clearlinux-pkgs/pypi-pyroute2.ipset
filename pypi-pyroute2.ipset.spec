...
Source0  : https://files.pythonhosted.org/packages/eb/f4/d67db31eab8e6be48e26dec18d2b8d0180b85cfdd213aa9be12163d5a6cf/pyroute2.ipset-0.6.11.tar.gz
...
%prep
%setup -q -n pyroute2.ipset-0.6.11
cd %{_builddir}/pyroute2.ipset-0.6.11
pushd ..
cp -a pyroute2.ipset-0.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654538367
...
cp %{_builddir}/pyroute2.ipset-0.6.11/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipset-0.6.11/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/4cc77b90af91e615a64ae04893fdffa7939db84c
