...
Version  : 0.6.7
Release  : 15
URL      : https://files.pythonhosted.org/packages/38/d8/300fe74080543dfb0d274de3a8a12f2b3ecad5bac241cd86dd9cf18746cb/pyroute2.ipset-0.6.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/38/d8/300fe74080543dfb0d274de3a8a12f2b3ecad5bac241cd86dd9cf18746cb/pyroute2.ipset-0.6.7.tar.gz
...
%prep
%setup -q -n pyroute2.ipset-0.6.7
cd %{_builddir}/pyroute2.ipset-0.6.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645464619
...
cp %{_builddir}/pyroute2.ipset-0.6.7/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipset-0.6.7/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/4cc77b90af91e615a64ae04893fdffa7939db84c
