...
Version  : 0.6.6
Release  : 14
URL      : https://files.pythonhosted.org/packages/8a/59/ff562d69359bd99efd6f3660a74f189111eda2dd0a293069819e248789b9/pyroute2.ipset-0.6.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/8a/59/ff562d69359bd99efd6f3660a74f189111eda2dd0a293069819e248789b9/pyroute2.ipset-0.6.6.tar.gz
...
%prep
%setup -q -n pyroute2.ipset-0.6.6
cd %{_builddir}/pyroute2.ipset-0.6.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645043953
...
cp %{_builddir}/pyroute2.ipset-0.6.6/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipset-0.6.6/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/4cc77b90af91e615a64ae04893fdffa7939db84c
