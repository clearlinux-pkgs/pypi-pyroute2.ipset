...
Source0  : https://files.pythonhosted.org/packages/54/22/71871c8c893fef7782252b810c9aceab0ad89183de71c027b759e0c14043/pyroute2.ipset-0.6.10.tar.gz
...
%prep
%setup -q -n pyroute2.ipset-0.6.10
cd %{_builddir}/pyroute2.ipset-0.6.10
pushd ..
cp -a pyroute2.ipset-0.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654528435
...
cp %{_builddir}/pyroute2.ipset-0.6.10/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipset-0.6.10/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ipset/4cc77b90af91e615a64ae04893fdffa7939db84c
